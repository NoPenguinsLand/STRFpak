function varargout = do_cached_calc(function_name,varargin)
...
if ~exist('dir_of_caches.m','file')
    disp('Function "do_cached_calc" cannot find the file "dir_of_caches.m", which tells it where to put its saved intermediate results.  Evaluating anyways...');
